...
```{r}
setwd("C:/Users/Gabby/Desktop/GJ_OSU_Thesis/GJ_OSU_Thesis/")

# combining files into a list
file_paths <- c(
  "Climate/primet/primet_230_a_5min_2015.csv",
  "Climate/primet/primet_230_a_5min_2016.csv",
  "Climate/primet/primet_230_a_5min_2017.csv",
  "Climate/primet/primet_230_a_5min_2018.csv",
  "Climate/primet/primet_230_a_5min_2019.csv",
  "Climate/primet/primet_230_a_5min_2020.csv",
  "Climate/primet/primet_230_a_5min_2021.csv",
  "Climate/primet/primet_230_a_5min_2022.csv",
  "Climate/primet/primet_230_a_5min_2023.csv",
  "Climate/primet/primet_230_a_5min_2024.csv"
  )

# Reading all files into a list of data.tables
data_list <- lapply(file_paths, fread)

# Combining all data tables, filling missing columns and resolving type mismatches - this would not work if we tried bind_rows() instead 
combined_data <- rbindlist(data_list, fill = TRUE)

# convert back to a df from a table
P230_df <- as.data.frame(combined_data)

#save as R object so we don't have to redo every time we want to recall the df
save(P230_df,file=here("P230.RData"))
```
...
#Combining all Primet files 2014-2024
```{r}
...
#checking for all flags to remove 
unique_primet_strings <- unique(
  unlist(
    sapply(
      Primet2014_2024, function(x) x[is.character(x)])))
```
