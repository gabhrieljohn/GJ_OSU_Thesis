...
#All relative file paths have "GJ)OSU_Thesis" as the working directory, e.g.,:
...
var_list_files<-list.files(path="raw_data_DSCMET422",full.names = TRUE, recursive = TRUE)
var_list_files
